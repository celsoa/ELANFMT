...
figure(4),clf,
Max_rec = 2048*1;
isyn_c_nameZ = sprintf('synseisDCsL.z.txt');isyn_cZ = load(isyn_c_nameZ);%DCsL Expl Coll
...
legend('Zhu and Rivera (2002)', 'Present study, FastWaveED GPU3D');ylim([-0.8 0.8]);   
